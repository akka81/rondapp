    ...
    public class DbCenters
    {
        ...
        public void LoadDbData()
        {
            if (RecreateDB())
            {
                ...
                if (Database.Table<CenterType>().Count() == 0)
                {
                    Database.Insert(new CenterType { ID = 0, Label = "Centro Aiuto" });
                    Database.Insert(new CenterType { ID = 1, Label = "Centro Ascolto" });
                    Database.Insert(new CenterType { ID = 2, Label = "Centro Diurno" });
                    Database.Insert(new CenterType { ID = 3, Label = "Deposito Bagagli" });
                    Database.Insert(new CenterType { ID = 4, Label = "Mensa" });
                    Database.Insert(new CenterType { ID = 5, Label = "Guardaroba" });
                    Database.Insert(new CenterType { ID = 6, Label = "Servizio Sanitario" });
                    Database.Insert(new CenterType { ID = 7, Label = "Servizi di Igiene Personale" });
                    Database.Insert(new CenterType { ID = 8, Label = "Servizi Legali" });
                    Database.Insert(new CenterType { ID = 9, Label = "Servizi Sociali Comune Milano" });
                }
                #endregion
                ...
                {
                    Database.Insert(new Hours { ID = 0, Label = "8.30-19.30" });
                    Database.Insert(new Hours { ID = 1, Label = "9.00-11.30" });
                    Database.Insert(new Hours { ID = 2, Label = "9.00-12.00" });
                    Database.Insert(new Hours { ID = 3, Label = "9.00-17.00" });
                    Database.Insert(new Hours { ID = 4, Label = "9.00-13.00" });
                    Database.Insert(new Hours { ID = 5, Label = "9.00-14.00" });
                    Database.Insert(new Hours { ID = 6, Label = "8.30-11.00" });
                    Database.Insert(new Hours { ID = 7, Label = "17.00-18.30" });
                    Database.Insert(new Hours { ID = 8, Label = "11.30-13.00" });
                    Database.Insert(new Hours { ID = 9, Label = "11.30" });
                    Database.Insert(new Hours { ID = 10, Label = "11.30-14.30" });
                    Database.Insert(new Hours { ID = 11, Label = "17.30-19.30" });
                    Database.Insert(new Hours { ID = 12, Label = "18.30-20.30" });
                    Database.Insert(new Hours { ID = 13, Label = "10.30-11.30" });
                    Database.Insert(new Hours { ID = 14, Label = "9.00-11.00" });
                    Database.Insert(new Hours { ID = 15, Label = "17.30-19.00" });
                    Database.Insert(new Hours { ID = 16, Label = "8.00" });
                    Database.Insert(new Hours { ID = 17, Label = "14.30-16.30" });
                    Database.Insert(new Hours { ID = 18, Label = "11.00-14.00" });
                    Database.Insert(new Hours { ID = 19, Label = "17.30-20.00" });
                    Database.Insert(new Hours { ID = 20, Label = "15.00-16.00" });
                    Database.Insert(new Hours { ID = 21, Label = "15.30" });
                    Database.Insert(new Hours { ID = 22, Label = "8.00-12.00" });
                    Database.Insert(new Hours { ID = 23, Label = "13.45-16.00" });
                    Database.Insert(new Hours { ID = 24, Label = "15.00-18.30" });
                    Database.Insert(new Hours { ID = 25, Label = "9.30-12.00" });
                    Database.Insert(new Hours { ID = 26, Label = "14.30-18.30" });
                    Database.Insert(new Hours { ID = 27, Label = "8.30-12.30" });
                    Database.Insert(new Hours { ID = 28, Label = "9.00-12.30" });
                    Database.Insert(new Hours { ID = 29, Label = "14.00-17.00" });
                    Database.Insert(new Hours { ID = 30, Label = "9.15-12.00" });
                    Database.Insert(new Hours { ID = 31, Label = "11.00-13.00" });
                    Database.Insert(new Hours { ID = 32, Label = "14.00-19.00" });
                    Database.Insert(new Hours { ID = 33, Label = "9.00-15.30" });
                    Database.Insert(new Hours { ID = 34, Label = "8.00-11.00" });
                    Database.Insert(new Hours { ID = 35, Label = "7.30" });
                    Database.Insert(new Hours { ID = 36, Label = "10.00-19.00" });
                    Database.Insert(new Hours { ID = 37, Label = "14.00-16.00" });
                    Database.Insert(new Hours { ID = 38, Label = "8.30-11.30" });
                    Database.Insert(new Hours { ID = 39, Label = "14.00-15.00" });
                    Database.Insert(new Hours { ID = 40, Label = "9.00-15.00" });
                    Database.Insert(new Hours { ID = 41, Label = "14.00-18.00" });
                    Database.Insert(new Hours { ID = 42, Label = "10.00-13.00" });
                    Database.Insert(new Hours { ID = 43, Label = "8.00-13.00" });
                    Database.Insert(new Hours { ID = 44, Label = "11.15-13.00" });
                    Database.Insert(new Hours { ID = 45, Label = "18.30-20.00" });
                    Database.Insert(new Hours { ID = 46, Label = "11.00-12.30" });
                    Database.Insert(new Hours { ID = 47, Label = "18.00-19.30" });
                    Database.Insert(new Hours { ID = 48, Label = "11.00" });
                    Database.Insert(new Hours { ID = 49, Label = "10.30" });
                    Database.Insert(new Hours { ID = 50, Label = "09.30-15.30" });
                    Database.Insert(new Hours { ID = 51, Label = "19.00-21.00" });
                }
                #endregion

                #region centers and openings
                int ID = 0;
                ID = AddCenter(new Center { IDType = 0, Address = "Via Ferranti Apporti, 3 - 20124 MILANO", Latitude = 45.489192, Longitude = 9.209655, Name = "Centro d'aiuto Stazione Centrale", Notes = "", PhoneNumber = "+390288447649", Reference = "Silvia Fiore", Services = "Coordina l'attività delle unità mobili notturne e diurne. Servizio sociale a bassa soglia. Gestisce la presa in carico di soggetti gravemente emarginati sia italiani sia stranieri. L'ufficio dispone di interpreti e mediatori culturali", Origin = "E", Gender = "E", MinAge = 0, MaxAge = 100, Hygiene = "N", Health = "N" });
